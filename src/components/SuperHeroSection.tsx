const SuperHeroSection = () => {
  return <section id="inicio" className="relative min-h-screen flex items-center bg-gradient-to-br from-white via-secondary/30 to-white overflow-hidden pt-20">
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-primary rounded-full filter blur-3xl"></div>
        <div className="absolute bottom-1/3 right-1/3 w-48 h-48 bg-secondary rounded-full filter blur-2xl"></div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="https://wa.me/5555991630055" target="_blank" rel="noopener noreferrer" className="btn-primary inline-flex items-center justify-center gap-2 text-gray-950 bg-[t] bg-[#e0f4ea]">
          ...
          <div className="relative lg:block animate-fade-in-up">
            <div className="relative">
              <div className="absolute -top-8 -left-8 w-72 h-72 bg-primary/20 rounded-full filter blur-2xl"></div>
              ...
              <div className="relative z-10 bg-white/90 backdrop-blur-sm shadow-2xl rounded-2xl p-1 transform transition-all duration-500 hover:scale-105">
                <img src="https://images.unsplash.com/photo-1586023492125-27b2c045efd7?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Colchões de alta qualidade Super Colchões Santa Maria" className="rounded-2xl w-full h-auto object-cover" />
              </div>
            </div>
          </div>
        </div>
