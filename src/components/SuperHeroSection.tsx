        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="https://wa.me/5555991630055" target="_blank" rel="noopener noreferrer" className="btn-primary inline-flex items-center justify-center gap-2">
              ...
              behavior: 'smooth'
            })} className="btn-primary text-[#0da456] bg-[#e0f4ea]">
                Como Chegar
              </button>
            </div>
          ...
          <div className="relative lg:block animate-fade-in-up">
            <div className="relative">
              ...
              <div className="relative z-10 bg-white/90 backdrop-blur-sm shadow-2xl rounded-2xl p-1 transform transition-all duration-500 hover:scale-105">
                <img src="/lovable-uploads/8bc0200e-2c73-4b31-918d-54eba6d54b4f.png" alt="Colchões de alta qualidade Super Colchões Santa Maria" className="rounded-2xl w-full h-auto object-cover" />
              </div>
            </div>
          </div>
        </div>
