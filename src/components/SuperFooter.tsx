    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Contato */}
          <div className="space-y-4">
            <h4 className="font-heading font-bold text-lg">Contato</h4>
          ...
          {/* Localização */}
          <div className="space-y-4">
            <h4 className="font-heading font-bold text-lg">Localização</h4>
            <div className="text-gray-300">
              <p>Esquina com a - Rua Riachuelo</p>
              <p>R. Tuiuti, 224 - Centro</p>
              <p>Santa Maria - RS</p>
              <p>CEP: 97050-010</p>
            </div>
          </div>
